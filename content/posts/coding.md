...
- Learn HTML/CSS to fill all screens. Minimize JS by progresively adding `htmx` and `Scss` to your HTML pages. Add web components to fix the corner case as the last resort.
...
- learn Zig for single core performance optimization and using C libraries more conveniently and as a replacement for Rust and C++.
